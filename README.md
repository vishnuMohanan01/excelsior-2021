...
5. To view your component during development, import and place that component inside the layout container of the page (Below the Landing Component, which is already placed).

   > For example: If you're developing for the index route.
   > 
   > Place the component inside the layout container in the **src/pages/index.js** (Below the Landing Component, which is already placed).
